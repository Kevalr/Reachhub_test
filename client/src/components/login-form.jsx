          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <div className="w-full px-4">
                <button
                  type="submit"
                  className="flex justify-center w-full mb-2 text-black bg-white hover:bg-slate-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  {!isUserLoggingIn ? (
                    "LOGIN"
                  ) : (
                    <svg
                      aria-hidden="true"
                      className="w-8 h-8 mr-2 text-gray-800 animate-spin fill-blue-600"
                      viewBox="0 0 100 101"
                      fill="none"
